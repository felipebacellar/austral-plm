export const SAMPLE_CAD: Record<string, any> = {
  ...
  cor: [
    { cod: "C01", nome: "BRANCO" },
    { cod: "C02", nome: "PRETO" },
    { cod: "C03", nome: "OFF WHITE" },
    { cod: "C04", nome: "NATURAL" },
    { cod: "C05", nome: "BEGE" },
    { cod: "C06", nome: "AZUL CLARO" },
    { cod: "C07", nome: "AZUL ESCURO" },
    { cod: "C08", nome: "CINZA CLARO" },
    { cod: "C09", nome: "CINZA ESCURO" },
    { cod: "C10", nome: "VERDE" },
    { cod: "C11", nome: "MARROM" },
    { cod: "C13", nome: "CORAL" },
    { cod: "C14", nome: "VD CLARO" },
    { cod: "C17", nome: "AMARELO" },
    { cod: "C20", nome: "AREIA" },
    { cod: "C25", nome: "KHAKI" },
  ],
  tecido: [
...
// Variantes de cor por referência de produto
...
export const SAMPLE_ROWS = [
  {
    ...
    ficha: {
      ...
      aviamentos: [
        ...
        { item: "ETIQUETA DE MARCA MÉDIA", cod: "ET0045", qtd: 1, valor: 0.39, local: "COSTURADO NAS LATERAIS SOBRE PARTE INFERIOR DO COBRE GOLA", var01: "CRU" },
