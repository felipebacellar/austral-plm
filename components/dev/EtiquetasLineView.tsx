...
@media screen {
  ...
  .etq-logo { height: 26px; width: auto; filter: invert(1); mix-blend-mode: screen; object-fit: contain; }
...
@media print {
  ...
  .etq-logo { height: 7mm; width: auto; filter: invert(1); mix-blend-mode: screen; object-fit: contain; }
